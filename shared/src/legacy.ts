...
export { prospectValuation, deriveStats, eligibleTraits, cardName, cardOf, CARD_DESC, type ProspectValue, type CareerPlayerAttrs, type Personality, type Card } from './career.js';
export { narratePlay, narrateCoach, narrateDraft, narrateOffer, scenarioStory, type NarrateCtx } from './narrate.js';
