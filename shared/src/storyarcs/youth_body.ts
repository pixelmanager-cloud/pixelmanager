...

  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'declare', label: 'Say it out loud before the week starts', desc: 'Name it while it is still small and boring', outcome: 'He says it and is given ten days of not doing the thing that hurts, which is dull and works. He is behind for a fortnight and completely fine by the end of the month.', effect: { energy: 5, form: -0.06, meters: { authority: 3 }, attr: { composure: 2 } } },
