...
export const YOUTH_BODY_ARCS: StoryArc[] = [
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'endure', label: 'Lie still and wait it out', desc: 'It always goes. Waking the house would only make it a thing', outcome: 'He lies with his heels flat against the cold part of the sheet and counts backwards from three hundred. It goes at some point; he never notices when. He is tired at school and fine by Thursday, and he does this for most of a year.', effect: { energy: -6, attr: { composure: 2 } } },
...

  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'rest', label: 'Sit the week out', desc: 'Two days on the sofa and come back clean', outcome: 'Two days of daytime television and a strange guilt. He comes back on Saturday breathing properly and slightly behind everyone, and is level with them again inside a fortnight.', effect: { energy: 8, form: -3, attr: { composure: 1 } } },
          { id: 'push', label: 'Train through it', desc: 'Nobody remembers who trained with a cold; they remember who was there', outcome: 'He trains, badly, twice. The cold goes down into his chest and stays for three weeks, and he spends February at about seventy per cent of himself, coughing on the walk home.', effect: { energy: -12, form: -5, attr: { aggression: 1 }, tag: 'body-chesty' } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'dismiss', label: 'Assume it is just what Saturdays feel like', desc: 'Everybody has a head on them after a game', outcome: 'He assumes it, for years. He is a slightly worse player in the last fifteen minutes than in the first fifteen for the whole of that time, and nobody, including him, ever names the reason.', effect: { energy: -5, form: -2 } },
        ],
      },
    },
  },
...

  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'adapt', label: 'Play the game his size can play', desc: 'Get it down, get it moving, stop trying to win headers', outcome: 'He becomes a nuisance at knee height — first to the second ball, impossible to shoulder off because there is nothing to get hold of. When the height finally arrives it lands on top of a skill set the big lads never had to build.', effect: { attr: { creativity: 2, flair: 1 }, tag: 'body-small-skills' }, next: 'later' },
          { id: 'fight', label: 'Refuse to be moved off it', desc: 'Go into everything, give away nothing', outcome: 'He gets flattened a lot and gets up faster than anyone expects, and the flattening stops being worth their while. He also spends the season covered in bruises he does not mention at home.', effect: { attr: { aggression: 2 }, energy: -5, tag: 'body-small-fight' }, next: 'later' },
          { id: 'shrink', label: 'Stop going where the contact is', desc: 'Find the space instead of the collision', outcome: 'He drifts to where nobody is, which keeps him on the ball and out of trouble, and slowly teaches him a habit of avoidance that will take years to unpick.', effect: { attr: { creativity: 1 }, form: -3, tag: 'body-small-avoid' }, next: 'later' },
        ],
      },
      later: {
        id: 'later',
        ...
        choices: [
          ...
          { id: 'test', label: 'Start using the height straight away', desc: 'Go and win a header, just to know he can', outcome: 'He goes up for one he would never have gone up for and wins it, and grins about it for a week. He also learns that a body arriving in pieces will let you down at the worst moment, twice, before it settles.', effect: { attr: { aggression: 1 }, form: 3, energy: -4 } },
        ],
      },
    },
  },

  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'declare', label: 'Say it out loud before the week starts', desc: 'Name it while it is still small and boring', outcome: 'He says it and is given ten days of not doing the thing that hurts, which is dull and works. He is behind for a fortnight and completely fine by the end of the month.', effect: { energy: 5, form: -3, meters: { authority: 3 }, attr: { composure: 2 } } },
          ...
          { id: 'ignore', label: 'Strike through it and see', desc: 'Hit one properly and find out if it is real', outcome: 'He hits one properly on the Thursday and it is real. Six weeks of not much, and a small permanent carefulness about that side.', effect: { injury: true, energy: -10, form: -6 } },
        ],
      },
      after: {
        id: 'after',
        ...
        choices: [
          ...
          { id: 'carry', label: 'Carry it to the end of the season', desc: 'He has got this far. It is eleven weeks', outcome: 'He gets to the end of the season carrying two things instead of one, playing a slightly smaller version of his own game, and everyone agrees it was a solid if unremarkable year for him.', effect: { energy: -8, form: -4, attr: { aggression: 1 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'stuff', label: 'Eat everything he can, quickly', desc: 'Volume. Whatever is in the cupboard, twice', outcome: 'He gets heavier in about six weeks and slower in about seven. It takes him most of a year to work out that the two were the same fact, and to undo it.', effect: { energy: -4, form: -3 } },
          { id: 'refuse', label: 'Decide slight is a way of playing, not a fault', desc: 'Get better at not being touched instead', outcome: 'He builds a game around never being where the shoulder is: half a yard earlier on everything, first touch always away from the contact. Some weeks it is beautiful. Some weeks he gets knocked off it in the first minute and stays off it.', effect: { attr: { creativity: 2, flair: 1 }, form: -1 } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'through', label: 'Run through it', desc: 'It is only shins. Everyone gets it', outcome: 'It is only shins until it is a stress fracture in the left one, found in September, eight weeks after he could first have stopped.', effect: { injury: true, energy: -12, form: -6 } },
        ],
      },
    },
  },
...

  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'sort', label: 'Get it all sorted, appointments and all', desc: 'Miss two sessions for a dentist. Feel ridiculous about it', outcome: 'He misses two Thursdays for something with no glamour in it whatsoever. He also sleeps properly for the first time since spring, and stops noticing his own head, which is what a head is meant to do.', effect: { energy: 8, form: 2, attr: { composure: 1 } } },
          { id: 'delay', label: 'Put it off until after the season', desc: 'Six weeks. He can chew on one side for six weeks', outcome: 'He puts it off, and chews on one side, and carries a low grey headache into every game in April without ever once connecting the two.', effect: { energy: -6, form: -3 } },
