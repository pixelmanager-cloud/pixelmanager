...
export const RELATIONSHIP_ARCS: StoryArc[] = [
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'learn', label: 'Soak it all up', desc: 'Extra hours, every drill, hang on his every word', outcome: 'He becomes the old man’s shadow — and it shows in the little details of his game.', effect: { attr: { teamwork: 1 }, meters: { authority: 8 }, tag: 'protege' }, next: 'goodbye' },
          { id: 'polite', label: 'Politely decline', desc: 'He’d rather find his own way', outcome: 'He nods, says thanks, and goes his own road. Independent — for better or worse.', effect: { attr: { creativity: 2 }, meters: { authority: -2 } } },
          { id: 'ask-to-lead', label: 'Ask him how to lead a room', desc: 'He wore an armband at twelve and never knew what to do with it', outcome: 'He tells the old man about an armband he was handed as a boy that he had no idea what to do with, and asks to be taught the part of the job nobody ever coaches. They spend a winter on it, and it costs him every evening he had.', effect: { energy: -14, attr: { leadership: 2 }, meters: { authority: 8, family: -8, peers: -4 } }, next: 'goodbye', requires: 'first-captain' },
        ],
      },
      goodbye: {
        id: 'goodbye',
        ...
        choices: [
          ...
          { id: 'own-path', label: 'Make it his own', desc: 'Respect the past, but do it his way', outcome: 'He keeps the lessons, drops the rest, and builds his own kind of leader.', effect: { attr: { leadership: 1, creativity: 2 }, meters: { peers: 6, authority: -5 } } },
    ...
    beats: {
      ...
      crunch: {
        ...
        choices: [
          ...
          { id: 'chase-game', label: 'Bury himself in the tie', desc: 'Love can wait; the manager can’t', outcome: 'He watches clips till 2am and plays a blinder — but he catches her packing a small bag by the door, and the win tastes of nothing.', effect: { meters: { partner: -12 }, attr: { creativity: 2 }, form: 0.05, tag: 'distracted' } },
        ],
      },
    },
  },
  ...
  // 2 — a FAMILY ILLNESS
  {
    ...
    beats: {
      ...
      recovery: {
        ...
        choices: [
          { id: 'closer', label: 'Hold them closer', desc: 'Buy Mum and Dad the house, be present, mean it', outcome: 'He moves them nearer the ground and starts driving over on days off. Football gave him the means; the fright gave him the sense.', effect: { meters: { family: 16 }, attr: { leadership: 1, teamwork: 1 }, earnings: -26, energy: -6 } },
          { id: 'harden', label: 'Bottle it and push on', desc: 'Turn the fear into fuel and say nothing', outcome: 'He thanks her, kisses her forehead, and drives back to training with the ache locked in a box. It makes him ruthless — and a little cold.', effect: { meters: { family: 4, peers: -6, partner: -5 }, attr: { aggression: 2 }, form: 0.05 } },
        ],
      },
    },
  },
  ...
  // 4 — a TEAMMATE BEST-FRIEND bond
  {
    ...
    beats: {
      bond: {
        ...
        choices: [
          { id: 'build-it', label: 'Build the partnership', desc: 'Extra sessions, telepathy, two minds one move', outcome: 'They stay behind to drill one-twos until the floodlights die. By month’s end defenders can’t tell where one of them ends and the other begins.', effect: { meters: { peers: 16, family: -6 }, attr: { teamwork: 2, creativity: 2 }, form: 0.06, energy: -12, tag: 'brothers' }, next: 'loyalty' },
  ...
  // 6 — a RIFT WITH HIS AGENT
  {
    ...
    beats: {
      ...
      decision: {
        ...
        choices: [
          { id: 'cut-loose', label: 'Cut him loose', desc: 'Terminate the deal, walk away clean', outcome: 'He tears up the contract and hands his career to someone new. It aches like a bereavement — but a man who lies once will lie again.', effect: { meters: { agent: -18, sponsors: 4 }, attr: { leadership: 2 } } },
  ...
  // 8 — an ACADEMY KID who looks up to him (he becomes the mentor)
  {
    ...
    beats: {
      ...
      debut: {
        ...
        choices: [
          { id: 'settle-him', label: 'Settle his nerves', desc: 'An arm round the shoulder, the right quiet word', outcome: 'He whispers the thing the old head once told him, and the kid walks out three inches taller and plays a blinder. Legacy isn’t medals — it’s this.', effect: { meters: { authority: 12, peers: 10, fans: 4, partner: -5 }, attr: { leadership: 2, composure: 1 }, form: 0.06, energy: -8 } },
          { id: 'step-back', label: 'Let him stand alone', desc: 'He’s ready — time to cut the last cord', outcome: 'He gives him a wink and nothing more, trusting the work to hold. The boy stumbles early, then finds himself — and does it on his own two feet.', effect: { meters: { authority: 8, peers: 6 }, attr: { leadership: 1, teamwork: 1 }, form: -0.03 } },
        ],
      },
    },
  },
  ...
  // 10 — a SIBLING whose own football dream stalled
  {
    ...
    beats: {
      ...
      jealousy: {
        ...
        choices: [
          { id: 'own-luck', label: 'Own how thin the line was', desc: 'Admit it could easily have gone the other way', outcome: 'He tells him the truth: an injury here, a scout looking the other way there, and their lives would have swapped. The honesty lands harder than any denial, and the brothers hold on.', effect: { meters: { family: 14 }, attr: { composure: 1, leadership: 1 }, form: -0.04 } },
          { id: 'walk-away', label: 'Walk out to cool down', desc: 'Say nothing he can’t take back, leave the room', outcome: 'He steps into the cold garden rather than fire back, and lets the storm pass. They never quite finish the conversation — but they don’t break, either.', effect: { meters: { family: 4 }, attr: { composure: 1, aggression: 1 }, energy: -5 } },
        ],
      },
    },
  },
  ...
  // 11 — a demanding FOOTBALL DAD who won't let go
  {
    ...
    beats: {
      ...
      thaw: {
        ...
        choices: [
          { id: 'forgive', label: 'Let it heal', desc: 'Take the words, forgive the years, hold his hand', outcome: 'He tells his dad it’s alright, that he heard him even when the praise was buried, and the two of them cry the way men in their family never do. The wound finally closes.', effect: { meters: { family: 18 }, attr: { composure: 1, leadership: 1, aggression: -1 } } },
          { id: 'too-late', label: 'Struggle to let it in', desc: 'The apology is real — but so are the years', outcome: 'He nods and holds the hand and can’t quite make the years dissolve on cue. Forgiveness, he learns, isn’t a switch — but he starts down the road.', effect: { meters: { family: 8 }, attr: { aggression: 1 }, form: -0.04 } },
        ],
      },
    },
  },
  ...
  // 12 — GRIEF over a mentor/coach who passed away
  {
    ...
    beats: {
      news: {
        ...
        choices: [
          { id: 'eulogy', label: 'Stand up and speak', desc: 'Put into words what the old man gave him', outcome: 'He stands before a packed church and finds the words for a debt he can never repay. He plays the opener with the man’s old motto scrawled inside his boot.', effect: { meters: { family: 6, fans: 6, authority: 6 }, attr: { leadership: 2 }, tag: 'grieving-coach' }, next: 'legacy' },
    ...
    beats: {
      ...
      firstdeal: {
        ...
        choices: [
          ...
          { id: 'bring-his-mate', label: 'Put his best mate in the room too', desc: 'The one man in football he trusts completely', outcome: 'He asks the one teammate he trusts without reservation to sit in on the negotiation, purely so there are two sets of honest ears in a room full of sharks. It is unorthodox, it embarrasses his agent, and it saves him from a clause nobody else spotted.', effect: { meters: { agent: -8, peers: 12 }, market: -4, attr: { teamwork: 2 } }, requires: 'brothers' },
        ],
      },
    },
  },
  ...
  // 15 — a FAN who has written to him for years
  {
    ...
    beats: {
      letters: {
        ...
        choices: [
          { id: 'visit', label: 'Go to the hospital', desc: 'No cameras, no fuss — just turn up', outcome: 'He drives over after training with a signed shirt and sits for an hour talking football with a boy who lights up like a floodlight. Some things are worth more than any fee.', effect: { meters: { fans: 16, family: 4 }, attr: { leadership: 1 }, energy: -8, tag: 'letters-answered' }, next: 'return' },
          { id: 'write-back', label: 'Write him back at last', desc: 'Six years of letters finally get a reply', outcome: 'He sits down and writes the boy the letter he should have written years ago, page after page in his own hand. It’s not a visit — but it’s real, and it’s his.', effect: { meters: { fans: 10 }, attr: { composure: 2 }, form: -0.03, tag: 'letters-answered' }, next: 'return' },
        ],
      },
      return: {
        id: 'return',
  ...
  // 16 — a new MANAGER who becomes a father figure
  {
    ...
    beats: {
      ...
      sacking: {
        ...
        choices: [
          { id: 'walk-him-out', label: 'Walk him out the front door', desc: 'Defy the club, honour the man', outcome: 'He ignores the memo, carries the old man’s boxes to the car in front of the cameras, and shakes his hand where everyone can see. Some debts you pay loudly, board or no board.', effect: { meters: { authority: -8, peers: 10, fans: 8 }, attr: { leadership: 2 } } },
  ...
  // 17 — a PARTNER with their own big career (two-body problem)
  {
    ...
    beats: {
      ...
      balance: {
        ...
        choices: [
          { id: 'build-system', label: 'Build a real system', desc: 'Shared diary, protected days, ironclad rules', outcome: 'They map the season and her rota onto one wall calendar and ring-fence the days that are sacred. It’s unromantic as hell, and it saves them — a partnership of equals, run like one.', effect: { meters: { partner: 16, family: 6, peers: -5, authority: -5 }, attr: { teamwork: 2 } } },
          { id: 'coast-hope', label: 'Trust love to sort it out', desc: 'They’ll figure it out as they go, like always', outcome: 'They toast to muddling through and leave the details to fate, because they always have. It works, mostly — until the next clash, which they both quietly know is coming.', effect: { meters: { partner: 6 }, attr: { composure: 1 }, energy: -8 } },
        ],
      },
    },
  },
  ...
  // 18 — FALLOUT then RECONCILIATION with an old teammate
  {
    ...
    beats: {
      ...
      rebuild: {
        ...
        choices: [
          { id: 'join-him', label: 'Say yes and mean it', desc: 'Rebuild the partnership off the pitch', outcome: 'He signs on, and the two of them stand on a windswept training ground again, older and softer, doing something that matters. The best partnerships, it turns out, get a second half.', effect: { meters: { peers: 16, fans: 6, family: -6 }, attr: { teamwork: 2, leadership: 1 }, energy: -8 } },
          { id: 'well-wish', label: 'Wish him well from afar', desc: 'Peace made — but not a business partner', outcome: 'He tells him he’s proud of him and means it, but keeps the venture at arm’s length. The friendship is mended; he’s just learned to guard how much he pours into it.', effect: { meters: { peers: 8, fans: -5 }, attr: { composure: 2 } } },
        ],
      },
    },
  },
  ...
  // 21 — a MEDIA PUNDIT who used to be his teammate
  {
    ...
    beats: {
      roasted: {
        ...
        choices: [
          { id: 'call-him', label: 'Call him, not the papers', desc: 'Sort it man to man, off the record', outcome: 'He rings him that night and asks, plainly, what happened to loyalty. The old friend admits the gantry made him forget the dressing room, and they clear the air like grown men.', effect: { meters: { peers: 10 }, attr: { composure: 1, leadership: 1 }, tag: 'pundit-truce' }, next: 'proof' },
          { id: 'answer-pitch', label: 'Answer him on the grass', desc: 'Say nothing — let the football talk', outcome: 'He bites his tongue in every interview and pours the anger into his game instead. The next month is the best football he’s played in years, every touch a rebuttal.', effect: { meters: { fans: 6, peers: -2 }, attr: { aggression: 2 }, form: 0.06, tag: 'pundit-feud' }, next: 'proof' },
        ],
      },
      proof: {
        id: 'proof',
        ...
        choices: [
          { id: 'gracious', label: 'Be gracious on air', desc: 'No gloating — reach across the divide', outcome: 'He tells the nation the criticism made him better and thanks his old mate for the fire. Grace, on the biggest stage, wins him more than the trophy ever could.', effect: { meters: { fans: 12, peers: 8, sponsors: 6 }, attr: { leadership: 2 } } },
          { id: 'remind-him', label: 'Remind him, live, of every word', desc: 'Let the man eat his autumn column on air', outcome: 'He looks down the lens and repeats the pundit’s own words back at him, and the studio squirms. It’s deliciously satisfying — and it costs a friendship he half-wanted back.', effect: { meters: { fans: 8, peers: -6 }, attr: { aggression: 1 }, form: 0.05 } },
        ],
      },
    },
  },
  ...
  // 22 — HOMESICKNESS eased by a countryman in the squad
  {
    ...
    beats: {
      lonely: {
        ...
        choices: [
          { id: 'lean-in', label: 'Cling to the familiar', desc: 'Home cooking, home tongue, a brother abroad', outcome: 'They cook the food of home in a foreign kitchen and rattle away in dialect nobody around can follow. For the first time since he landed, the homesickness loosens its grip.', effect: { meters: { peers: 12, family: 6, authority: -6 }, attr: { composure: 1, teamwork: 1 }, form: 0.05, tag: 'homesick-eased' }, next: 'adapt' },
          { id: 'stay-brave', label: 'Force himself to integrate', desc: 'Lean on the countryman, but push into the new', outcome: 'He takes the comfort but makes himself sit with the local lads too, wrestling the language a phrase at a time. Harder, lonelier some nights — but he’s building a life, not a bubble.', effect: { meters: { peers: 8, authority: 4 }, attr: { leadership: 1 }, energy: -8, form: -0.04, tag: 'integrating' }, next: 'adapt' },
          { id: 'let-the-ball-talk', label: 'Do what worked when he was fourteen', desc: 'He has been the boy who could not speak before', outcome: 'He was fourteen on a tour once with nobody he could talk to, and he found out then that a ball bouncing off a corridor wall is a language everyone in a football club already speaks. He starts a two-touch game after training every day, and it takes every scrap of energy he had left.', effect: { energy: -14, meters: { peers: 14, authority: 6, family: -6 }, attr: { teamwork: 2 }, form: -0.03, tag: 'integrating' }, next: 'adapt', requires: 'away-language-ball' },
        ],
      },
      adapt: {
        id: 'adapt',
  ...
  // 23 — a PUBLIC PROPOSAL / WEDDING clash with the season
  {
    ...
    beats: {
      ...
      wedding: {
        ...
        choices: [
          { id: 'wedding-first', label: 'Marry her, miss the tie', desc: 'Tell the gaffer some things come first', outcome: 'He looks the manager in the eye and says he’ll take the fine and the fury, because he only marries her once. He walks down the aisle a man who knows exactly what matters.', effect: { meters: { partner: 20, family: 12, authority: -8 }, attr: { leadership: 2 } } },
  ...
  // 26 — the GRANDPARENT who raised him, now ageing
  {
    ...
    beats: {
      fading: {
        ...
        choices: [
          { id: 'move-her-close', label: 'Move her near him', desc: 'A place round the corner, carers, whatever it takes', outcome: 'He gently talks her out of the old house and into a bright flat two streets from the ground, and starts calling in every single day. She grumbles about the fuss and secretly loves every minute.', effect: { meters: { family: 18, authority: -2 }, earnings: -10, attr: { leadership: 1 }, tag: 'nan-close' }, next: 'goodbye' },
          { id: 'honour-wishes', label: 'Let her keep her home', desc: 'Bring the care to her, respect her stubborn pride', outcome: 'He can’t bring himself to uproot the woman who never uprooted him, so he wires the old house with help and drives the long road to her instead. Her dignity stays intact; his diary does not.', effect: { meters: { family: 14 }, attr: { composure: 1, teamwork: 1 }, tag: 'nan-home' }, next: 'goodbye' },
        ],
      },
      goodbye: {
        id: 'goodbye',
    ...
    beats: {
      anointed: {
        ...
        choices: [
          ...
          { id: 'in-writing', label: 'Ask the old man to put it in writing', desc: 'Someone who called himself family emptied his pockets once', outcome: 'A man who called himself family has already gone through his money once, and he is not doing that twice. He thanks the owner warmly and then asks, pleasantly, for the board-seat talk to be put on paper by a solicitor. The warmth in the room drops about ten degrees and never fully returns.', effect: { meters: { authority: -12, agent: -6, peers: 8 }, attr: { composure: 1, leadership: 1 }, earnings: -6, tag: 'own-man' }, next: 'ask', requires: 'betrayed' },
        ],
      },
      ask: {
        id: 'ask',
  ...
  // 31 — a JEALOUS FRIEND from home who resents his success
  {
    ...
    beats: {
      ...
      test: {
        ...
        choices: [
          { id: 'stand-by-him', label: 'Stand by him anyway', desc: 'Bail him out, trust the boy he grew up with', outcome: 'He clears the debt and looks his mate dead in the eye, choosing the twelve-year-old he kicked a ball with over the bitter man in front of him. The lad weeps, tears up the number of the journalist, and comes home to himself.', effect: { meters: { peers: 16, family: 6 }, earnings: -10, attr: { leadership: 2 }, form: 0.05 } },
