    ...
    beats: {
      ...
      recovery: {
        ...
        choices: [
          ...
          { id: 'harden', label: 'Bottle it and push on', desc: 'Turn the fear into fuel and say nothing', outcome: 'He thanks her, kisses her forehead, and drives back to training with the ache locked in a box. It makes him ruthless — and a little cold.', effect: { meters: { family: 4, peers: -6, partner: -5 }, attr: { aggression: 2, composure: 1 }, form: 0.05 } },
        ],
      },
    },
  },
  ...
  // 10 — a SIBLING whose own football dream stalled
  {
    ...
    beats: {
      ...
      jealousy: {
        ...
        choices: [
          { id: 'own-luck', label: 'Own how thin the line was', desc: 'Admit it could easily have gone the other way', outcome: 'He tells him the truth: an injury here, a scout looking the other way there, and their lives would have swapped. The honesty lands harder than any denial, and the brothers hold on.', effect: { meters: { family: 14 }, attr: { composure: 2, leadership: 1 }, form: -0.04 } },
  ...
  // 11 — a demanding FOOTBALL DAD who won't let go
  {
    ...
    beats: {
      ...
      thaw: {
        ...
        choices: [
          { id: 'forgive', label: 'Let it heal', desc: 'Take the words, forgive the years, hold his hand', outcome: 'He tells his dad it’s alright, that he heard him even when the praise was buried, and the two of them cry the way men in their family never do. The wound finally closes.', effect: { meters: { family: 18 }, attr: { composure: 2, leadership: 1, aggression: -1 } } },
          { id: 'too-late', label: 'Struggle to let it in', desc: 'The apology is real — but so are the years', outcome: 'He nods and holds the hand and can’t quite make the years dissolve on cue. Forgiveness, he learns, isn’t a switch — but he starts down the road.', effect: { meters: { family: 8 }, attr: { composure: 1, aggression: 1 }, form: -0.04 } },
        ],
      },
    },
  },
  ...
  // 15 — a FAN who has written to him for years
  {
    ...
    beats: {
      letters: {
        ...
        choices: [
          { id: 'visit', label: 'Go to the hospital', desc: 'No cameras, no fuss — just turn up', outcome: 'He drives over after training with a signed shirt and sits for an hour talking football with a boy who lights up like a floodlight. Some things are worth more than any fee.', effect: { meters: { fans: 16, family: 4 }, attr: { composure: 1, leadership: 1 }, energy: -8, tag: 'letters-answered' }, next: 'return' },
  ...
  // 17 — a PARTNER with their own big career (two-body problem)
  {
    ...
    beats: {
      ...
      balance: {
        ...
        choices: [
          { id: 'build-system', label: 'Build a real system', desc: 'Shared diary, protected days, ironclad rules', outcome: 'They map the season and her rota onto one wall calendar and ring-fence the days that are sacred. It’s unromantic as hell, and it saves them — a partnership of equals, run like one.', effect: { meters: { partner: 16, family: 6, peers: -5, authority: -5 }, attr: { teamwork: 2, composure: 1 } } },
