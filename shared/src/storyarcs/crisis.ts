...
export const CRISIS_ARCS: StoryArc[] = [
  ...
  },
  {
    ...
    minTurn: 50, maxTurn: 105, weight: 2, first: 'open',
    beats: {
      open: {
        id: 'open',
  ...
  },
  {
    ...
    beats: {
      ...
      test: {
        ...
        choices: [
          { id: 'rally', label: 'Rouse the room', desc: 'Band or no band, this is a job for the biggest voice', outcome: 'He’s up and roaring, organising, dragging them out for the second half by the scruff. They come back and win it — leadership needs no armband.', effect: { form: 0.12, energy: -10, attr: { leadership: 2, composure: 1 }, meters: { peers: 12, fans: 10, authority: 9 } } },
          { id: 'defer', label: 'Prop up the new skipper', desc: 'Whisper in his ear, let the kid wear the moment', outcome: 'He quietly feeds the young captain the words and lets him deliver them. The comeback is the lad’s — but everyone knows whose steel it was.', effect: { form: 0.07, market: -4, attr: { leadership: 1, teamwork: 1 }, meters: { peers: 9, authority: 5 } } },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      ...
      fallout: {
        ...
        choices: [
          { id: 'perform', label: 'Repay the faith with a display', desc: 'Play his heart out and celebrate straight to the dugout', outcome: 'He runs himself into the turf, scores, and sprints to embrace the manager in front of the world. The story is dead by Monday.', effect: { form: 0.11, attr: { teamwork: 1, composure: 1 }, meters: { authority: 8, fans: 9, peers: -7 } } },
          { id: 'quiet', label: 'Keep his head down and grind', desc: 'No grand gestures — just an honest, quiet, undeniable shift', outcome: 'He lets the performance speak without theatrics, solid and selfless, and the noise slowly loses interest for lack of oxygen.', effect: { form: 0.06, attr: { teamwork: 1 }, meters: { peers: 6, authority: 4, fans: -6, sponsors: -4 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      verdict: {
        ...
        choices: [
          { id: 'rise', label: 'Channel it into a performance', desc: 'Take every ounce of the anger and pour it into the game', outcome: 'He plays like a man reborn, running the match, and points to the badge at the final whistle. Vindication, earned in full view.', effect: { form: 0.12, energy: -10, attr: { aggression: 1, composure: 1 }, meters: { fans: 12, authority: 7, family: -6 } } },
          { id: 'weary', label: 'Just try to feel normal again', desc: 'No statement, no fireworks — simply be a footballer once more', outcome: 'He gets through the ninety quietly, more relieved than triumphant, and lets the ordinary rhythm of the game start to heal him.', effect: { form: 0.05, market: -5, attr: { composure: 2 }, meters: { family: 8, partner: 6, sponsors: -4 } } },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    minTurn: 46, maxTurn: 116, weight: 3, first: 'open',
    beats: {
      open: {
        id: 'open',
  ...
  },
  {
    ...
    minTurn: 56, maxTurn: 107, weight: 2, first: 'open',
    beats: {
      open: {
        id: 'open',
  ...
  },
  {
    ...
    minTurn: 46, maxTurn: 118, weight: 3, first: 'open',
    beats: {
      open: {
        id: 'open',
  ...
  },
  {
    ...
    minTurn: 46, maxTurn: 114, weight: 2, first: 'open',
    beats: {
      open: {
        id: 'open',
      ...
      cleared: {
        ...
        choices: [
          { id: 'burn-it', label: 'Answer the slur with a masterclass', desc: 'Take the anger of the injustice and win the game single-handed', outcome: 'He plays with a cold fire all afternoon, runs the show, and stares down the away end that branded him, the record set straight in studs.', effect: { form: 0.12, attr: { aggression: 1, composure: 1 }, meters: { fans: 11, authority: 7, sponsors: -6 } } },
          { id: 'rebuild-quiet', label: 'Quietly rebuild what was taken', desc: 'No revenge mission — just clean, honest football again', outcome: 'He lets the chants wash over him and simply gets back to playing, trusting time and clean displays to scrub away the stain.', effect: { form: 0.06, market: -5, attr: { composure: 2 }, meters: { sponsors: 5, family: 6, fans: -4 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      aftermath: {
        ...
        choices: [
          { id: 'unify', label: 'Drag the fractured room back together', desc: 'Whatever side he took, now be the glue that mends it', outcome: 'He calls a players-only meeting, buries the grievances, and demands they play for each other, forcing unity out of the wreckage.', effect: { form: 0.1, energy: -8, attr: { leadership: 2, teamwork: 1 }, meters: { peers: 10, authority: 7 } } },
          { id: 'coast-out', label: 'Keep his head down and ride it out', desc: 'Say nothing, do his job, let the poison dilute itself', outcome: 'He avoids the politics entirely and just plays, letting the fault lines slowly close over on their own without his fingerprints.', effect: { form: 0.04, attr: { composure: 1 }, meters: { authority: 3, peers: -7 } } },
        ],
      },
    },
  },
  {
    ...
    minTurn: 46, maxTurn: 117, weight: 2, first: 'open',
    beats: {
      open: {
        id: 'open',
