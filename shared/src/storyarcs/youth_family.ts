    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'quiet', label: 'Say nothing and keep going', desc: 'Don\'t make it another thing they have to carry', outcome: 'He acts like he hasn\'t noticed anything. It is its own kind of work. He stops asking for anything at all that winter.', effect: { meters: { family: 5 }, attr: { stamina: 1 }, energy: -4, tag: 'fam-said-nothing' }, next: 'month' },
      ...
      month: {
        ...
        choices: [
          ...
          { id: 'thanks', label: 'Just say thank you', desc: 'No grand gesture — say it and mean it', outcome: 'He says thanks and leaves it there. His mum tells him years later it was the only time that whole autumn she felt like they were winning.', effect: { meters: { family: 12 }, attr: { teamwork: 1 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'ask', label: 'Ask her about it', desc: 'Get the box down and make her talk', outcome: 'She talks for an hour, then stops abruptly and puts the lid back on. But after that she stands nearer the halfway line.', effect: { meters: { family: 10 }, attr: { creativity: 2 }, tag: 'fam-mum-talked' }, next: 'garden' },
      ...
      garden: {
        ...
        choices: [
          { id: 'learn', label: 'Let her show him something', desc: 'Take the coaching from the one person who never gives it', outcome: 'She shows him a way of taking the ball across her body that nobody at the club has taught him. It stays in his game for twenty years.', effect: { attr: { creativity: 2, flair: 2 }, meters: { family: 10 }, form: 0.05 } },
          { id: 'beat', label: 'Try to nutmeg his mum', desc: 'He\'s a kid and she\'s in work shoes — easy', outcome: 'She takes it off him twice and doesn\'t gloat. That is worse. He goes to bed furious and gets up early to practise.', effect: { attr: { flair: 2, aggression: 1 }, meters: { family: 8 }, energy: -4 } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      later: {
        ...
        choices: [
          { id: 'play', label: 'Play the best game of his life', desc: 'Show him exactly what he\'s been missing', outcome: 'He scores twice and doesn\'t look at the fence once. His dad tells everyone in the car park that he gets it from him.', effect: { form: 0.1, energy: -8, attr: { flair: 2, aggression: 1 }, meters: { family: 4, peers: 4 } } },
  ...
  },
  {
    ...
    beats: {
      ...
      back: {
        ...
        choices: [
          { id: 'own', label: 'Own the choice', desc: 'Say it out loud rather than let it sit', outcome: 'He says he\'d make the same call again, and that he\'s sorry it hurt. Both halves of that land.', effect: { attr: { leadership: 1 }, meters: { family: 8 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'detail', label: 'Give him every last detail', desc: 'Come home and talk him through all ninety minutes', outcome: 'He learns to describe a match properly: the shape, the moment it turned, the mistake nobody else spotted. It changes how he watches football.', effect: { energy: -4, attr: { creativity: 2 }, meters: { family: 12 }, tag: 'fam-match-reports' }, next: 'after' },
  ...
  },
  {
    ...
    beats: {
      ...
      boots: {
        ...
        choices: [
          { id: 'sit', label: 'Sit down and do the other boot', desc: 'Say nothing, pick up the brush', outcome: 'They clean boots in silence for ten minutes. It is the first evening the house feels like it has four people in it rather than three and a visitor.', effect: { meters: { family: 12 }, attr: { teamwork: 1 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'buses', label: 'Work out the buses', desc: 'Two changes, an hour and ten, a very early alarm', outcome: 'He does the route on paper and then does it, every week, in the dark half the winter. Nobody at the club ever finds out.', effect: { energy: -10, attr: { stamina: 1 }, meters: { family: 8 }, tag: 'fam-buses' }, next: 'lift' },
    ...
    beats: {
      ...
      photo: {
        ...
        choices: [
          ...
          { id: 'skip', label: 'Find a reason to be somewhere else', desc: 'He knows what the photos will and won\'t show', outcome: 'He is out at the park every time the envelope comes out. Nobody makes a thing of it. That is how he knows it is a thing.', effect: { meters: { family: -4 }, attr: { flair: 2 }, form: 0.04 } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'set-down', label: 'Refuse to carry it', desc: 'It\'s a game and he\'s a child', outcome: 'He decides, privately, that it isn\'t his job to rescue anyone. He plays lighter for it, and feels guilty about that too.', effect: { attr: { composure: 1, flair: 2 }, form: 0.05, meters: { family: -2 }, tag: 'fam-set-it-down' }, next: 'talk' },
        ],
      },
      talk: {
        id: 'talk',
        ...
        choices: [
          { id: 'honest', label: 'Tell her what it felt like', desc: 'Say that it\'s heavy', outcome: 'He tells her it scares him. She pulls over and tells him she\'d rather have him than a footballer, and he believes about eighty per cent of it.', effect: { meters: { family: 12 }, attr: { leadership: 1 } } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'shrug', label: 'Let him hang around', desc: 'He can join in, but this is proper practice', outcome: 'The boy fetches the ball out of the hedge two hundred times a night and thinks it\'s the greatest thing that\'s ever happened to him.', effect: { form: 0.05, attr: { flair: 2 }, meters: { family: 4 }, tag: 'fam-brother-fetches' }, next: 'game' },
          { id: 'push', label: 'Tell him to find his own thing', desc: 'Being a copy of someone won\'t make him happy', outcome: 'He says it kindly and it lands like a slap. The boy takes up swimming and is county standard within three years.', effect: { meters: { family: -4 }, attr: { leadership: 1 }, tag: 'fam-sent-him-off' }, next: 'game' },
        ],
      },
      game: {
        id: 'game',
        ...
        choices: [
          ...
          { id: 'own', label: 'Stay for his own warm-down', desc: 'Do the professional thing', outcome: 'He does everything right and gets home to a boy who scored and wanted to tell him first. He gets the story second-hand off his mum.', effect: { attr: { stamina: 1 }, meters: { authority: 6, family: -4 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      later: {
        ...
        choices: [
          { id: 'invite', label: 'Ask him to come and train with him', desc: 'Get him back on grass, even just once', outcome: 'They do an hour on the park in the dark. His cousin\'s touch is still there, and neither of them says anything about that.', effect: { attr: { creativity: 2, flair: 2 }, form: 0.05, meters: { family: 10 }, energy: -4 } },
          { id: 'listen', label: 'Ask him what he saw', desc: 'Take the one honest opinion in his family', outcome: 'His cousin tells him two things he\'s doing wrong that no coach has mentioned, then apologises for interfering. He works on both.', effect: { attr: { creativity: 2 }, form: 0.06, meters: { family: 8 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'learn', label: 'Ask her to show him how', desc: 'Take over the socks from now on', outcome: 'She shows him: cold water first, always. He does his own kit from then on, badly at first, and she stops setting an alarm for Sunday nights.', effect: { meters: { family: 12 }, attr: { teamwork: 1 }, tag: 'fam-does-own-kit' }, next: 'bag' },
      ...
      bag: {
        ...
        choices: [
          { id: 'say', label: 'Say sorry, properly', desc: 'Not a mumble on the way out the door', outcome: 'He apologises properly and means it. She tells him it\'s nothing; the bag never gets left again.', effect: { meters: { family: 10 }, attr: { leadership: 1 } } },
          { id: 'rule', label: 'Make it a rule for himself', desc: 'Bag emptied within an hour of getting in, forever', outcome: 'He makes the rule and keeps it. Kit men at three different clubs will one day comment on it without ever knowing where it came from.', effect: { energy: -4, attr: { teamwork: 1 }, meters: { family: 8, authority: 4 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'company', label: 'Ask for one person to sit with him', desc: 'Whoever\'s free, just don\'t make him eat on his own', outcome: 'They rota it without telling him. It takes him months to realise it isn\'t a coincidence that someone is always at the table.', effect: { meters: { family: 8 }, attr: { teamwork: 1 }, tag: 'fam-rota' }, next: 'sat' },
        ],
      },
      sat: {
        id: 'sat',
    ...
    beats: {
      ...
      shift: {
        ...
        choices: [
          ...
          { id: 'excuse', label: 'Tell her it\'s not a big one', desc: 'Give her a way out she can take without guilt', outcome: 'He plays it down so she\'ll sleep. She finds out afterwards what it actually was, and doesn\'t speak to him for a whole evening.', effect: { meters: { family: -4 }, attr: { teamwork: 1 } } },
