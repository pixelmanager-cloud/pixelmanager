  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'keepball', label: 'Take the ball home', desc: 'Write the date on it in biro', outcome: 'He carries it home under his arm the whole bus journey and writes the date on the panel in blue biro, pressing hard enough to dent it.', effect: { form: 0.08, attr: { flair: 2 }, meters: { family: 5, peers: 4, authority: -5 }, tag: 'hattrick-ball' }, next: 'next' },
      ...
      next: {
        ...
        choices: [
          { id: 'chase', label: 'Chase the feeling', desc: 'Shoot from everywhere until it comes back', outcome: 'He starts shooting from angles that were never on, and the goals stay away another fortnight before they remember where he lives.', effect: { form: -0.05, attr: { aggression: 1, flair: 2 } } },
          { id: 'build', label: 'Go back to doing the boring things', desc: 'Runs, touches, the stuff before the goal', outcome: 'He goes back to the unglamorous half of it — the near-post run, the first touch away from the centre half — and the goals start again without being asked.', effect: { form: 0.05, attr: { teamwork: 1 }, meters: { authority: 6 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      test: {
        ...
        choices: [
          { id: 'hit', label: 'Hit it left-footed', desc: 'This is what the winter was for', outcome: 'He hits it first time with the left and it goes in, and the odd thing is how ordinary it feels — like a thing he simply does now.', effect: { form: 0.08, attr: { flair: 2 }, meters: { authority: 6 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'drill', label: 'Attack the next one properly', desc: 'Eyes open, neck strong, meet it early', outcome: 'He makes himself go early at the next six, gets one on the ear and one on the bridge of the nose, and wins the seventh cleanly.', effect: { energy: -5, attr: { aggression: 1 }, meters: { authority: 5 } } },
          { id: 'avoid', label: 'Play where the ball stays down', desc: 'Not everyone has to be good in the air', outcome: 'He quietly arranges his game so the ball never arrives above his shoulders, and it works fine for about two years.', effect: { attr: { creativity: 2 }, tag: 'aerially-shy' } },
          { id: 'ask', label: 'Get someone to throw them at him', desc: 'Twenty a night in the back garden until the flinch dies', outcome: 'Twenty throws a night at the garden fence, and the flinch dies somewhere in the second week without him noticing it go.', effect: { energy: -4, attr: { stamina: 1 }, meters: { family: 5 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'simple', label: 'Play simple and let it die', desc: 'Nothing to prove, and a game to win', outcome: 'He plays the ball early for twenty minutes and the temperature comes down. Somebody\'s dad calls him sensible, which at twelve is not a compliment.', effect: { attr: { teamwork: 1 }, meters: { authority: 5 }, tag: 'nutmeg-defused' }, next: 'after' },
        ],
      },
      after: {
        id: 'after',
        ...
        choices: [
          { id: 'hand', label: 'Shake his hand before kickoff', desc: 'Take the feud out of it', outcome: 'He puts a hand out in the tunnel line and the boy takes it, and the game is a proper game instead of a grudge with a ball in it.', effect: { attr: { leadership: 1 }, meters: { authority: 5, peers: 4 } } },
          { id: 'feed', label: 'Let him stew', desc: 'An angry defender is a bad defender', outcome: 'He says nothing, drifts across into his half of the pitch all afternoon, and the boy gets booked inside eight minutes chasing him.', effect: { form: 0.05, attr: { flair: 2, aggression: 1 }, meters: { peers: 6, authority: -6 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'adapt', label: 'Change how he plays for the water', desc: 'No dribbling. Everything first time, everything early', outcome: 'He works out inside ten minutes that the ball will not run, and starts hitting everything first time and early. It is the first time he has beaten a pitch instead of a team.', effect: { form: 0.07, attr: { creativity: 2 }, meters: { authority: 7 }, energy: -6 } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'love', label: 'Fall in love with the quick surface', desc: 'The ball does what he tells it here', outcome: 'On the carpet everything he tries actually works, and he spends the winter playing the best football of his life on a pitch that smells of burnt tyres.', effect: { form: 0.07, attr: { flair: 2, creativity: 2 }, meters: { peers: 5 }, tag: 'astro-native' }, next: 'spring' },
      ...
      spring: {
        ...
        choices: [
          { id: 'relearn', label: 'Relearn the heavy pitch', desc: 'Shorter steps, stronger through contact', outcome: 'He spends two weeks looking ordinary, shortens his stride, gets his weight lower, and comes out of it able to play on anything.', effect: { energy: -6, attr: { stamina: 1 }, form: 0.04, meters: { authority: 5 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'claim', label: 'Wheel away and claim it', desc: 'It is in the book as a goal either way', outcome: 'He runs off with both arms up like he meant it, and keeps a completely straight face for the rest of the afternoon.', effect: { form: 0.05, attr: { flair: 2 }, meters: { peers: 5, authority: -5 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'own', label: 'Own it in front of everyone', desc: 'Say it out loud before it festers', outcome: 'He says it plainly in the huddle — that one was mine, sorry — and something about saying it stops it growing in the dark.', effect: { attr: { leadership: 1 }, meters: { peers: 6, authority: 5 }, tag: 'miss-owned' }, next: 'again' },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'apologise', label: 'Apologise to the lad first', desc: 'Before he walks, before anyone tells him to', outcome: 'He stops and puts a hand out to the boy on the floor, who takes it. Then he walks the diagonal on his own. It is the longest walk of his life so far.', effect: { form: -0.05, attr: { leadership: 1 }, meters: { authority: 4, peers: 5 }, tag: 'red-apologised' }, next: 'ban' },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'chance', label: 'Take everything he can get', desc: 'No referee means no punishment', outcome: 'He claims every throw and every corner whether it is his or not, wins about four of them, and the game degenerates into a shouting match by half time.', effect: { form: 0.03, attr: { aggression: 1, flair: 2 }, meters: { peers: -4, authority: -4 } } },
          { id: 'referee', label: 'Try to run the game himself', desc: 'Somebody has to, or it stops', outcome: 'He ends up settling other people\'s arguments all afternoon. Exhausting, thankless, and he is very good at it.', effect: { energy: -6, attr: { leadership: 2 }, meters: { authority: 5, peers: 4 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      ...
      play: {
        ...
        choices: [
          { id: 'ground', label: 'Keep it on the floor all night', desc: 'What he cannot see he will not play', outcome: 'He plays everything along the ground, one and two touch, and has the best passing game of his season out of pure self-preservation.', effect: { form: 0.06, attr: { teamwork: 1, creativity: 2 }, meters: { authority: 5 } } },
          { id: 'trust', label: 'Judge it earlier and trust it', desc: 'Move to where it will land, not where it is', outcome: 'He starts moving to where the ball is going instead of tracking it through the dark, and it works often enough to be worth the two he gets wrong.', effect: { attr: { creativity: 2 }, form: 0.04, meters: { authority: -4 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'wall', label: 'The wall, every evening', desc: 'Two hundred against the gable end until it is too dark', outcome: 'He gets to know one square of brickwork better than anyone alive — which side it kicks off, where it comes back low — and his first touch is built entirely out of it.', effect: { energy: -5, attr: { flair: 2 }, tag: 'wall-hours' }, next: 'burst' },
      ...
      burst: {
        ...
        choices: [
          ...
          { id: 'replace', label: 'Get another one and start again', desc: 'It was only ever a ball', outcome: 'A new one turns up, harder and shinier, and it takes him three weeks to break it in and about a day to stop mentioning the old one.', effect: { attr: { flair: 2 }, form: 0.03 } },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'early', label: 'Walk the pitch an hour before', desc: 'In trainers, alone, corner flag to corner flag', outcome: 'He walks it corner to corner in his trainers an hour before anyone else is out, and by kickoff it is just a pitch and he is the only one on his team it is just a pitch to.', effect: { attr: { composure: 1, leadership: 1 }, form: 0.06, meters: { authority: 5 }, tag: 'walked-the-pitch' }, next: 'game' },
      ...
      game: {
        ...
        choices: [
          ...
          { id: 'width', label: 'Use the width, make them run', desc: 'Switch it, every time, and let the pitch do the work', outcome: 'He starts switching it first time to the far touchline, and the tired legs are on the other team by seventy minutes.', effect: { energy: -6, form: 0.07, attr: { creativity: 2, teamwork: 1 }, meters: { authority: 6 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'tricks', label: 'Play with everything he has got', desc: 'Small pitch, tight spaces, no fear', outcome: 'In eight-minute games nothing costs anything, so he tries all of it — drag-backs, no-looks, a rabona that goes into a fence — and about a third of it comes off.', effect: { energy: -8, attr: { flair: 2, creativity: 2 }, meters: { peers: 6 }, form: 0.05 } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'take', label: 'Pick the ball up', desc: 'Wanting it and taking it are different things', outcome: 'He picks it up because someone has to and being frightened is not a reason. He puts it down the middle, of all places, and does not celebrate.', effect: { form: 0.07, attr: { composure: 1, leadership: 1 }, meters: { authority: 6, peers: 6 }, tag: 'took-the-pen' }, next: 'after' },
