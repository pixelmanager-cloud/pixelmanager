  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'kill', label: 'Bury the second and end it', desc: 'No mercy — put the tie beyond doubt', outcome: 'He races clear and slots it home to make it two, and the giant-killing is complete. {RIVAL} trudge off humiliated while a stadium of nobodies sings until their throats bleed. The romance of the cup, alive and roaring.', effect: { energy: -14, greed: 1, form: 0.13, market: 5, attr: { aggression: 1, leadership: 1 }, meters: { fans: 24, peers: 10 } } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'mindgames', label: 'Play the mind games, then stand tall', desc: 'Delay, unsettle him, wait him out on his feet', outcome: 'He toys with the taker, dawdling on his line and pointing to a corner, and the spooked striker snatches at it — straight into his chest as he holds his ground and swallows it whole. The save is all in the head, and {RIVAL} know they were beaten before the ball was even struck.', effect: { earnings: -60, form: 0.12, market: 3, attr: { keeping: 2, leadership: 1 }, meters: { fans: 20, peers: 10 } } },
