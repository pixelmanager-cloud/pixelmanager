...
export const SIGNATURE_ARCS: StoryArc[] = [
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'solo', label: 'Take them all on', desc: 'Head down, everything or nothing', outcome: 'He beats one, two, three, and buries it. A goal replayed for a generation — even {RIVAL} forgotten in an instant.', effect: { energy: -12, form: 0.12, market: 4, attr: { flair: 2, creativity: 2 }, meters: { peers: -6, fans: 22 }, tag: 'legend-goal' } },
          { id: 'team', label: 'Play the killer pass', desc: 'The unselfish option, the right option', outcome: 'He slides in the winner for a teammate — no glory, all class. The room loves him for it.', effect: { form: 0.08, attr: { teamwork: 1, creativity: 2 }, meters: { agent: -8, peers: 14, fans: 8 } } },
          { id: 'park-run', label: 'Run it like the park', desc: 'The same run he made ten thousand times in the dark', outcome: 'He does not think, because he has done this ten thousand times against nobody at all — the same swerve, the same drop of the shoulder, the same finish into the same corner of an imaginary net. The ball goes in and he is a boy again for a second, and then a whole stadium is screaming a name he barely recognises.', effect: { energy: -14, form: 0.13, market: 5, attr: { flair: 2, stamina: 1 }, meters: { fans: 24, peers: -6 } }, requires: 'always-a-ball' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'smash', label: 'Lash it in', desc: 'No thinking — just hit it', outcome: 'The net bulges and the stadium detonates. He wheels away, shirt off, booked and beaming. Scenes.', effect: { earnings: -60, form: 0.12, market: 3, attr: { aggression: 1 }, meters: { authority: -5, fans: 20, peers: 10 } } },
          { id: 'compose', label: 'Take a touch', desc: 'Kill it dead, pick his spot, ice in the veins', outcome: 'One touch, side-foot, bottom corner — the coolest head in the ground. A finish they’ll show for years.', effect: { form: 0.1, market: 3, attr: { aggression: -1, composure: 2 }, meters: { fans: 18 } } },
          { id: 'still-running', label: 'Be where he always is', desc: 'He never stopped running, not even at nine-nil down', outcome: 'He is on the six-yard line because he has never once in his life stopped running for a lost cause, and the ball finds men like that. He stabs it in and the ground detonates around a lad who learned this in a hammering nobody else remembers.', effect: { energy: -12, form: 0.12, market: 3, attr: { stamina: 2, teamwork: 1 }, meters: { fans: 20, peers: 12, sponsors: -5 } }, requires: 'never-stopped' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'curl', label: 'Curl it into the top bino', desc: 'Go for the ridiculous, the unforgettable', outcome: 'He bends it up and over the wall into the postage stamp — a hat-trick sealed in the most outrageous fashion. The ball is his, the night is his, and the stands are bedlam.', effect: { energy: -6, greed: 2, form: 0.13, market: 4, attr: { flair: 2 }, meters: { fans: 24, peers: 8 } } },
          { id: 'tuck', label: 'Slot it low and sure', desc: 'No heroics, just the treble in the bag', outcome: 'Cool as you like, he rolls it inside the far post and completes the treble. He gathers the match ball off the net and holds it aloft like a newborn. Pure, unshakeable class.', effect: { form: 0.11, market: 3, attr: { flair: -1, composure: 2 }, meters: { fans: 18, agent: 6 } } },
          { id: 'second-ball', label: 'Finish it the way he finished his first', desc: 'There is already a ball on a shelf at home', outcome: 'There is a scuffed match ball on a shelf at home with a boy’s handwriting on it, and he knows exactly what a third goal is worth. He takes the same touch he took that day and puts it in the same corner, and this time forty thousand people are watching.', effect: { energy: -8, greed: 1, form: 0.13, market: 4, attr: { composure: 2 }, meters: { fans: 22, family: 10, peers: -6 } }, requires: 'hattrick-ball' },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'steer', label: 'Guide it past the dive', desc: 'Precision over power, thread the needle', outcome: 'He opens his body and steers it inside the post as the keeper flails — title won by the width of a coat of paint. Delirium. He sinks to his knees as blue smoke and bodies swallow him whole.', effect: { form: 0.13, market: 5, attr: { composure: 1, leadership: 1 }, meters: { fans: 26, sponsors: 6 } } },
          { id: 'kept-the-vow', label: 'Score it for the town', desc: 'He promised a terrace full of nobodies, years ago', outcome: 'He made a promise once from a cold terrace with a pie going soft in his hand, and he has carried it like a stone ever since. He puts it away without celebrating at all, then turns and points at his own end until his arm shakes. Debt paid, in front of everyone.', effect: { energy: -10, form: 0.13, market: 4, attr: { leadership: 2 }, meters: { fans: 26, sponsors: -6 } }, requires: 'world-town-vow' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        id: 'open',
        prompt: 'Drawn against {RIVAL}\'s lot, the moneyed giants everyone has already handed the tie to, his little club is the punchline of the round. Then a loose ball breaks to him in the dying minutes, one-nil the underdogs, a nation watching the David-and-Goliath live.',
        choices: [
          { id: 'kill', label: 'Bury the second and end it', desc: 'No mercy — put the tie beyond doubt', outcome: 'He races clear and slots it home to make it two, and the giant-killing is complete. {RIVAL}\'s lot trudge off humiliated while a stadium of nobodies sings until their throats bleed. The romance of the cup, alive and roaring.', effect: { energy: -14, greed: 1, form: 0.13, market: 5, attr: { aggression: 1, leadership: 1 }, meters: { fans: 24, peers: 10 } } },
          { id: 'shield', label: 'Shield it to the corner flag', desc: 'Kill the clock, protect the miracle', outcome: 'He hugs the ball into the corner and runs the seconds down like a seasoned pro twice his age, and the whistle confirms the shock of the round. He soaks up every second of the ovation. Giants slain.', effect: { energy: -6, form: 0.11, attr: { composure: 1, teamwork: 1 }, meters: { agent: -5, fans: 18, peers: 12 } } },
          { id: 'their-carpet', label: 'Finish it in their own house', desc: 'He walked corridors like these as a boy and wanted them', outcome: 'He was shown round a place like this once as a kid and left aching for it, and he has never quite forgiven the feeling. He runs at them until the tie is dead, then stands in the middle of their pitch and refuses to celebrate a thing. The giants have never been quieter.', effect: { energy: -16, form: 0.13, market: 5, attr: { aggression: 2, stamina: 1 }, meters: { fans: 22, peers: -5 } }, requires: 'away-facilities-hungry' },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        id: 'open',
        prompt: 'The shootout has run to sudden death against {RIVAL}\'s lot, the whole endless night distilled into this one lonely walk to the spot. The keeper dances the line, the world holds still, and it is all on him from twelve yards.',
        choices: [
          { id: 'panenka', label: 'Dink the Panenka', desc: 'Ice-cold audacity or eternal ridicule', outcome: 'He chips it feather-soft down the middle as the keeper hurls himself away, the ball settling in the empty net like a snowflake. The nerve of it! His teammates bury him beneath a mountain of bodies — the coolest man in the country.', effect: { form: 0.13, market: 5, attr: { composure: 2, flair: 2 }, meters: { authority: -8, fans: 24, peers: 12 } } },
          { id: 'hammer', label: 'Smash it into the roof', desc: 'No guessing, just pace and precision', outcome: 'He steps up and thunders it into the top of the net with the keeper still leaning, and the whistle blows on triumph. He sprints the length of the pitch, arms wide, mobbed at the halfway line as {RIVAL}\'s lot slump to the turf.', effect: { energy: -10, form: 0.12, market: 4, attr: { composure: 1, aggression: 1 }, meters: { fans: 22, peers: 10 } } },
          { id: 'volunteered-again', label: 'Take it the way he always has', desc: 'He put his hand up for one of these as a boy', outcome: 'He was the only one who put a hand up in a shootout on a windswept field years ago, and he has taken every one since exactly the same way — one spot chosen early, no thinking, no changing his mind. It goes precisely where it always goes.', effect: { energy: -8, form: 0.13, market: 4, attr: { composure: 1, leadership: 1 }, meters: { fans: 22, peers: 10, authority: -5 } }, requires: 'away-pens-volunteered' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'outside', label: 'Bend it with the outside of the boot', desc: 'The showman’s pass, disguise and all', outcome: 'He wraps the outside of his foot around it and the ball curves through the eye of a needle, dropping perfectly into stride. The finish is a formality; the pass is the thing they’ll talk about for years — a defence-splitting act of vision.', effect: { greed: 1, form: 0.12, market: 4, attr: { creativity: 3 }, meters: { fans: 16, peers: 14 } } },
          { id: 'nolook', label: 'Slide the no-look through-ball', desc: 'Eyes elsewhere, deceive the whole defence', outcome: 'Body shaped one way, gaze fixed the other, he threads it blind between three defenders and it splits them like they were bollards. His teammate can’t miss, and won’t. Assist of the season, no debate.', effect: { form: 0.11, attr: { creativity: 2, teamwork: 1 }, meters: { authority: -6, peers: 16, fans: 12 } } },
          { id: 'the-picture', label: 'Play the picture in his head', desc: 'He has seen the game this way since he was a boy', outcome: 'There was an afternoon in his childhood when the whole game rearranged itself in front of him and never went back, and this is what it gave him. He plays a ball nobody else in the ground even knew existed, and the finish is an afterthought.', effect: { form: 0.13, market: 4, attr: { creativity: 3 }, meters: { fans: 16, peers: 16, sponsors: -6 } }, requires: 'saw-the-game' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'first-touch', label: 'Shoot with his first ever touch', desc: 'No time to think, only to believe', outcome: 'First touch, first kick, first goal — he lashes it in seconds after coming on and the fairytale writes itself. The commentator loses his mind, the bench empties onto him, and up in the stands his family are in floods. A debut for the storybooks.', effect: { form: 0.13, market: 5, attr: { flair: 2 }, meters: { fans: 20, family: 14, agent: 6 } } },
          ...
          { id: 'knows-the-place', label: 'Play like he has stood here before', desc: 'He once walked a pitch this size in total silence', outcome: 'He walked every yard of a ground like this one as a boy, in silence, learning its size so it could never frighten him. It does not frighten him now. He takes his time, picks his spot, and scores his first with the calm of a man on his hundredth.', effect: { energy: -6, form: 0.13, market: 4, attr: { composure: 2 }, meters: { fans: 18, family: 14, agent: -6 } }, requires: 'walked-the-pitch' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'lob', label: 'Lob him from distance', desc: 'The audacity of a lifetime — go on, try it', outcome: 'He clips it early and high and the whole ground turns to watch it float, the keeper back-pedalling in horror as it drops under the bar off the faintest kiss of the woodwork. From his own half! An absurd, jaw-dropping goal that belongs on every highlight reel ever cut.', effect: { greed: 2, form: 0.14, market: 6, attr: { flair: 2, creativity: 2 }, meters: { authority: -5, fans: 26, sponsors: 8 } } },
          { id: 'drive', label: 'Drive forward and make sure', desc: 'Carry it in rather than chance the impossible', outcome: 'He resists the madness, gallops into the acres of space, and rounds the scrambling keeper to roll it into an empty net. Not the worldie it might have been, but a cool, clinical solo goal that has the crowd on their feet all the same.', effect: { energy: -12, form: 0.1, market: 3, attr: { composure: 1, stamina: 1 }, meters: { fans: 16 } } },
          { id: 'the-wall-again', label: 'Strike it like it is a wall', desc: 'Ten thousand repetitions against a brick wall', outcome: 'A brick wall in a back alley taught him what a ball does when you hit it in exactly that spot, and his body remembers before his head has finished the thought. It drops under the bar from sixty yards, and he laughs out loud at the wall that made him.', effect: { energy: -8, greed: 1, form: 0.14, market: 6, attr: { flair: 2, composure: 1 }, meters: { fans: 26, peers: -6 } }, requires: 'wall-fifty' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'weave', label: 'Weave through the lot of them', desc: 'Every touch a gamble, the crowd rising with each beaten man', outcome: 'He glides past five in a mazy, end-to-end slalom that has the ground on its feet before he even reaches the box, then dinks it home with the outside of his boot. A one-man goal they’ll be showing when he’s old and grey — sheer, undiluted genius.', effect: { energy: -18, greed: 1, form: 0.14, market: 6, attr: { flair: 3, stamina: 1 }, meters: { fans: 26, peers: 10 } } },
          { id: 'release', label: 'Draw them in, then release', desc: 'Carry it sixty yards, commit the defence, unselfish at the death', outcome: 'He carries it the length of the field, sucking in three defenders, and rolls the simplest of squares for a teammate to tap into an open net. The run was his; the goal he gave away. The bench is delirious at the sheer nerve of the carry.', effect: { energy: -12, form: 0.11, attr: { stamina: 2, teamwork: 1 }, meters: { agent: -6, peers: 16, fans: 14 } } },
          { id: 'the-cage', label: 'Run it like the cage', desc: 'Tight spaces, no whistle, no mercy — his old classroom', outcome: 'He grew up on a caged pitch where nobody blew a whistle and the only way out was through, and a football field feels enormous by comparison. He goes through all of them the way he used to go through grown men on tarmac, and finishes without ever looking up.', effect: { energy: -18, form: 0.14, market: 6, attr: { flair: 3, stamina: 1 }, meters: { fans: 26, peers: -6, authority: -5 } }, requires: 'cage-kid' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'topcorner', label: 'Rifle it into the top corner', desc: 'Pure venom, up and over, no half-measures', outcome: 'He strikes it with everything and it screams up over the wall and dips venomously into the postage stamp before the keeper has even flinched. The net nearly rips off its pegs. A thunderbolt of a free-kick that leaves the whole ground gasping.', effect: { greed: 1, form: 0.13, market: 5, attr: { aggression: 1, flair: 2 }, meters: { peers: -6, fans: 24, sponsors: 6 } } },
          { id: 'curl', label: 'Bend it around the wall', desc: 'Whip and finesse, kiss the far post', outcome: 'He caresses it round the outside of the wall with the inside of his boot, the ball curling wickedly away from the diving keeper and nestling off the far upright. Not power but poetry — a set-piece of surgical, breathtaking precision.', effect: { form: 0.12, market: 4, attr: { flair: 2 }, meters: { sponsors: -5, fans: 20, peers: 8 } } },
          { id: 'ten-thousand', label: 'Hit the one he has hit ten thousand times', desc: 'Hours alone with a ball and a wall and nobody watching', outcome: 'Nobody watched him hit this free-kick ten thousand times in the dark with a ball that was never quite round, and that is precisely why he can hit it now. Over, dip, in — and he barely reacts, because in his head it has already happened a thousand times.', effect: { energy: -6, form: 0.13, market: 5, attr: { composure: 2, flair: 2 }, meters: { fans: 24, peers: -6, sponsors: -4 } }, requires: 'wall-hours' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'hook', label: 'Hook it clear off the line', desc: 'Throw a boot at it, acrobatics be damned', outcome: 'He flings himself back and hooks it off the line with the ball already a foot over the paint, clawing the certain goal away by a whisker. The stadium erupts as if a goal had been scored the other way — a last-ditch clearance that saves the whole night.', effect: { energy: -12, form: 0.12, attr: { aggression: 1, teamwork: 2 }, meters: { fans: 20, peers: 14 } } },
          { id: 'header', label: 'Head it off the line', desc: 'Ice-cool, rise and nod it to safety', outcome: 'He plants himself on the line and heads it away with a composure that belies the chaos around him, nodding the ball to safety as bodies pile in. No dramatics, just a defender reading the danger a half-second before anyone else. Match saved.', effect: { form: 0.1, attr: { aggression: -1, composure: 2, teamwork: 1 }, meters: { peers: 16, fans: 14 } } },
          { id: 'cover-his-mate', label: 'Cover for his mate and wear the impact', desc: 'It was his best friend who switched off', outcome: 'It was his best friend in the whole game who switched off for the header, and he is back on the line covering it before the thought has finished forming. He hacks it clear and takes a boot in the ribs doing it, then gets up and says not one word about whose fault it was.', effect: { energy: -14, injury: true, form: 0.12, attr: { teamwork: 3 }, meters: { fans: 18, peers: 18, agent: -6 } }, requires: 'brothers' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'dive', label: 'Read it and fly', desc: 'Trust the gut, commit early, full stretch', outcome: 'He gambles a fraction before the strike and hurls himself low to his right, fingertips clawing the ball onto the post and away. The whistle goes moments later on a clean sheet stolen from the jaws of ruin. A penalty save that turns a keeper into a folk hero.', effect: { form: 0.13, market: 4, attr: { keeping: 3 }, meters: { authority: -5, fans: 24, peers: 12 } } },
          { id: 'mindgames', label: 'Play the mind games, then stand tall', desc: 'Delay, unsettle him, wait him out on his feet', outcome: 'He toys with the taker, dawdling on his line and pointing to a corner, and the spooked striker snatches at it — straight into his chest as he holds his ground and swallows it whole. The save is all in the head, and {RIVAL} knew he was beaten before the ball was even struck.', effect: { earnings: -60, form: 0.12, market: 3, attr: { keeping: 2, leadership: 1 }, meters: { fans: 20, peers: 10 } } },
          { id: 'old-habit', label: 'Do what he did when they stuck him in goal', desc: 'He has stood on this line before, aged eleven', outcome: 'The first time he stood on a goal line he was eleven and nobody else wanted the gloves, and he learned that night to wait, and wait, and move last. He waits now until the striker has committed everything, then takes it clean off the man’s boot.', effect: { energy: -10, form: 0.13, market: 4, attr: { keeping: 3, composure: 1 }, meters: { fans: 22, peers: 10, authority: -6 } }, requires: 'went-in-goal' },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        id: 'open',
        prompt: '{RIVAL}, the last defender back, squares up to him at the edge of the box, feet planted, daring him to try something. There is a gap between those boots, a sliver of daylight, and a devil on his shoulder whispering that he should.',
        choices: [
          { id: 'meg', label: 'Nutmeg him and finish', desc: 'Roll it through his legs, then bury it — pure humiliation', outcome: 'He slips it clean through the defender’s legs, skips round the other side, and rifles it into the roof of the net in one contemptuous motion. The man he beat is left sitting on the grass, nutmegged and beaten, as the away end drowns in noise. Cruel, brilliant, unforgettable.', effect: { greed: 1, form: 0.13, market: 5, attr: { flair: 3 }, meters: { authority: -6, fans: 24, peers: 8 } } },
          { id: 'shimmy', label: 'Shimmy past and slot it', desc: 'Drop the shoulder, glide by, no need to embarrass', outcome: 'He drops a shoulder that sends the defender the wrong way entirely, strolls into the space, and passes it calmly into the corner. Less circus than the nutmeg, but a moment of icy control that dismantles {RIVAL} just the same. The finish never in doubt.', effect: { form: 0.11, market: 3, attr: { flair: 2, composure: 2 }, meters: { fans: 18, sponsors: -4 } } },
          { id: 'twice-again', label: 'Do it twice, like he did back then', desc: 'He once megged the same lad twice in one night', outcome: 'He nutmegged a boy twice in one game as a kid and got chased the length of a car park for it, and he has never once seen a reason to stop. He puts it through, collects it, puts it through the covering man too, and rolls it in. They will sing about it for years.', effect: { energy: -8, greed: 2, form: 0.13, market: 5, attr: { flair: 3 }, meters: { authority: -8, fans: 24, peers: -6 } }, requires: 'nutmeg-repeat' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'rabona', label: 'Wrap the rabona in', desc: 'Cross it with his standing leg — audacity incarnate', outcome: 'He wraps his kicking foot behind his standing leg and whips a rabona cross onto a plate, the ball curling in with impossible spin for a header that can’t miss. A pass so absurd the commentator simply laughs — an assist of pure, preening theatre.', effect: { greed: 2, form: 0.12, market: 4, attr: { flair: 3, creativity: 2 }, meters: { fans: 22, peers: 10 } } },
          { id: 'cutback', label: 'Check back and cut it', desc: 'Take the touch, do it properly, no showboating', outcome: 'He checks onto his stronger foot, buys himself the yard, and clips a measured cutback that his teammate sweeps home. Not the party trick the crowd craved, but a cross of ruthless efficiency and a goal all the same. The professional’s choice.', effect: { form: 0.1, attr: { creativity: 2, teamwork: 2 }, meters: { sponsors: -5, peers: 14, fans: 10 } } },
          { id: 'wrong-foot-right', label: 'Just use the wrong foot properly', desc: 'He spent a whole winter making it his good one', outcome: 'He spent a joyless winter as a boy doing everything left-footed until the word wrong stopped applying, and now there is no such thing as his weaker side. He simply crosses it, first time, dead onto a head. No theatre required, and the crowd never even understands what it just watched.', effect: { form: 0.12, market: 3, attr: { creativity: 2, teamwork: 2 }, meters: { sponsors: -8, peers: 16, fans: 12 } }, requires: 'weak-foot-work' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'laces', label: 'Hit it first time', desc: 'No touch, no thought, everything through the ball', outcome: 'He leathers it on the drop without breaking stride and the ball flies like a tracer, dipping and swerving over the back-pedalling keeper and in under the bar from forty yards. A screamer of a goal that has grown men clutching their heads in disbelief.', effect: { greed: 2, form: 0.14, market: 6, attr: { aggression: 1, flair: 2 }, meters: { peers: -6, fans: 26, sponsors: 8 } } },
          { id: 'dip', label: 'Take a touch and place the dipper', desc: 'Steady it, pick the spot, guile over brute force', outcome: 'He kills it dead, spots the keeper stranded, and floats a dipping, guided effort that drops just beneath the bar with surgical timing. Less brute violence than the first-time hit, but a strike of gorgeous vision that no one saw coming. The bench is on its feet.', effect: { form: 0.12, market: 4, attr: { aggression: -1, composure: 1, creativity: 2 }, meters: { fans: 20, peers: 8 } } },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'burn', label: 'Burn him for pace and finish', desc: 'Full throttle, leave the defender for dead', outcome: 'He hits top gear and simply sprints away from the trailing defender, eating up the pitch before rolling it coolly under the advancing keeper. A one-man counter finished with a heartbeat that never rose above resting — devastating on the break, ice at the death.', effect: { energy: -16, form: 0.13, market: 5, attr: { stamina: 2, composure: 1 }, meters: { fans: 22, peers: 10 } } },
          { id: 'dummy', label: 'Wait, dummy the keeper, roll it in', desc: 'Slow it down, freeze the goalie, make him commit', outcome: 'He deliberately slows, lets the keeper come, sells him a shot that never arrives, and strolls the ball into the vacated net with an outrageous coolness. Seventy yards of sprint and then the calmest of finishes — a solo counter of pure, taunting composure.', effect: { form: 0.12, market: 4, attr: { composure: 2, flair: 2 }, meters: { peers: -6, fans: 20 } } },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'charge', label: 'Drag them up the pitch himself', desc: 'Carry it, will it, lead by the sheer force of doing', outcome: 'He powers forward through two challenges, refusing to be knocked off it, and smashes home a goal that rips the belief clean out of {RIVAL}. Ten men, and their captain has dragged them ahead by force of will alone. He roars at his own bench to keep going — a leader made of granite.', effect: { energy: -16, form: 0.14, market: 5, attr: { leadership: 2, aggression: 1 }, meters: { fans: 24, peers: 16 } } },
          { id: 'settle', label: 'Settle them, then finish calm', desc: 'Compose the team, control the moment, ice the goal', outcome: 'He waves his players into shape, slows the tempo to a crawl, then picks his moment to slide a finish inside the post with the composure of a man twice capped. A captain’s goal born of clear-headed control — ten men and utterly unshaken. The bench salutes their skipper.', effect: { form: 0.12, market: 4, attr: { aggression: -1, leadership: 3, composure: 1 }, meters: { peers: 18, fans: 18 } } },
          { id: 'first-armband', label: 'Lead them like the first time he was given the band', desc: 'He has worn one of these since he was twelve', outcome: 'The first armband he ever wore was too big for his arm and he did not sleep the night before, and he has never once treated one casually since. He gets hold of the game, drags nine tired men into shape, and then finishes it himself with nothing left in the tank.', effect: { energy: -18, form: 0.13, market: 4, attr: { leadership: 3, stamina: 1 }, meters: { fans: 22, peers: 16, family: -6 } }, requires: 'first-captain' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'leap', label: 'Out-jump the giant', desc: 'Spring early, hang in the air, win the unwinnable duel', outcome: 'He launches himself a fraction before the giant and hangs there, somehow rising above a man towering over him to thump the header down and in. The whole ground gasps at the sheer defiance of physics — the little man who beat the tower to the ball.', effect: { energy: -8, form: 0.13, market: 4, attr: { aggression: 2 }, meters: { fans: 22, peers: 12 } } },
          { id: 'lose', label: 'Lose him with a clever run', desc: 'Peel off blind-side, cunning over muscle', outcome: 'Rather than fight the losing battle, he ghosts off the giant’s blind side at the last second and meets the ball completely unmarked, nodding it home with the big man left grasping at air. A header won by brains, not brawn — the smartest movement on the pitch.', effect: { form: 0.11, attr: { creativity: 2 }, meters: { sponsors: -4, fans: 16, peers: 10 } } },
          { id: 'smallest-again', label: 'Climb him the way he learned to', desc: 'He was the smallest boy on every pitch he ever played on', outcome: 'He was the smallest boy on every pitch he ever stood on, and he learned early exactly where to put a forearm and when to leave the ground. He gets there first, over a man a head taller, and the header is in before the giant has even jumped.', effect: { energy: -10, form: 0.13, market: 4, attr: { aggression: 2, leadership: 1 }, meters: { fans: 22, peers: 12, authority: -6 } }, requires: 'small-tough' },
        ],
      },
    },
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'chip', label: 'Chip it over the diving keeper', desc: 'A Panenka in open play — ice-cold, feather-light', outcome: 'As the keeper commits and dives at his feet, he simply scoops it feather-soft over the sprawling body and watches it loop gently down into the empty net. A dink of breathtaking cheek in the run of play — the coldest blood in the building.', effect: { greed: 2, form: 0.13, market: 5, attr: { composure: 2, flair: 2 }, meters: { authority: -6, fans: 22, peers: 8 } } },
          { id: 'slide', label: 'Slide it past the outstretched hand', desc: 'Take the safe side, roll it low and sure', outcome: 'He waits the keeper out and rolls it low past the flailing hand into the corner, no theatrics, just the clean certainty of a finisher who never doubted. Not the audacious dink, but a one-on-one dispatched with textbook, unhurried calm.', effect: { form: 0.1, attr: { flair: -1, composure: 2 }, meters: { fans: 14 } } },
          { id: 'chipped-before', label: 'Chip him, the way he once chipped a whole county', desc: 'He has done this in front of eleven people and survived', outcome: 'He chipped one of these as a boy in front of a handful of freezing parents and got called every name going for it, and it went in then too. He scoops it, watches it drop, and turns away before it lands. Nerve is a thing you either practised young or you did not.', effect: { greed: 2, form: 0.13, market: 5, attr: { composure: 3 }, meters: { authority: -8, fans: 22, peers: -5 } }, requires: 'away-pens-chipped' },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'slide', label: 'Sprint him down and slide the tackle', desc: 'Chase the impossible, then a perfect toe-poke at full stretch', outcome: 'He devours the ten-yard gap with a recovery sprint that seems to bend physics, times his slide to the last inch, and pokes the ball clean off the striker’s toe as the shot loads. A saving tackle so perfectly judged the crowd roars as though a goal had gone in the other end. The last man, and he did not miss.', effect: { energy: -16, form: 0.13, market: 4, attr: { stamina: 2, aggression: 1 }, meters: { fans: 22, peers: 14 } } },
          { id: 'shepherd', label: 'Shepherd him wide and force the error', desc: 'Catch up, stay on his feet, angle him off the goal', outcome: 'Rather than gamble on the tackle, he claws his way alongside and calmly ushers the striker away from goal and toward the byline, closing the angle until the shot dribbles wide. No dramatics, just a defender who ran his heart out and then kept his head. Danger strangled at the death.', effect: { energy: -9, form: 0.1, attr: { stamina: 1, composure: 2 }, meters: { agent: -4, peers: 12, fans: 10 } } },
          { id: 'out-of-position', label: 'Defend it like the year they played him at the back', desc: 'A season he hated taught him how strikers think', outcome: 'A coach once stuck him at the back for a whole season and he hated every minute of it, and it is the most useful thing anybody ever did to him. He does not dive in; he takes the angle a defender takes, and the striker simply runs out of pitch.', effect: { energy: -14, form: 0.12, attr: { composure: 1, teamwork: 2 }, meters: { agent: -6, peers: 16, fans: 14 } }, requires: 'learned-defending' },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        id: 'open',
        prompt: 'The winner is there to be made in the dying embers, but {RIVAL} and another defender have funnelled across to shut the door, standing him up on the touchline with a runner unmarked and howling in the middle. It is one against two, and his feet are already twitching.',
        choices: [
          { id: 'burst', label: 'Stepover both of them and square it', desc: 'Trademark shimmy, burst the gap, lay the winner on a plate', outcome: 'He rolls out his trademark stepover, sells the first defender a dummy so complete the man nearly falls over, bursts clean through the gap the second leaves, and rolls the simplest of squares for the winner into an unguarded net. Two men beaten with a flick of the hips and the game won — the assist of an artist at the death.', effect: { energy: -8, greed: 1, form: 0.13, market: 5, attr: { flair: 3 }, meters: { fans: 22, peers: 12 } } },
          { id: 'clip', label: 'Disguise a clip over the top instead', desc: 'Freeze them with the shimmy, then chip the pass early', outcome: 'He feints the stepover just enough to root both defenders, then clips a disguised ball over the top before they recover, dropping it perfectly for the runner to steer home the winner. No mazy burst, just a moment of guile that unpicks two men with a single deft touch. The cleverest pass on the pitch.', effect: { form: 0.11, attr: { creativity: 2, teamwork: 1 }, meters: { sponsors: -5, peers: 14, fans: 10 } } },
          { id: 'square-to-the-enemy', label: 'Square it to the man he has not spoken to', desc: 'The runner in the middle is the one he is at war with', outcome: 'The man screaming for it in the middle is the same man he has not exchanged a civil word with since autumn, and he plays the pass anyway, perfectly weighted, without a flicker. The winner goes in. Neither of them celebrates with the other, and the whole bench notices.', effect: { energy: -8, form: 0.12, market: -3, attr: { teamwork: 2, composure: 1 }, meters: { peers: 8, authority: 8, fans: 14, sponsors: -5 } }, requires: 'at-war' },
        ],
      },
    },
  },
