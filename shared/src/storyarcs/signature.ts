...
export const SIGNATURE_ARCS: StoryArc[] = [
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'solo', label: 'Take them all on', desc: 'Head down, everything or nothing', outcome: 'He beats one, two, three, and buries it. A goal replayed for a generation — even {RIVAL} forgotten in an instant.', effect: { energy: -12, form: 0.12, market: 4, attr: { flair: 2, creativity: 1 }, meters: { peers: -6, fans: 22 }, tag: 'legend-goal' } },
          { id: 'team', label: 'Play the killer pass', desc: 'The unselfish option, the right option', outcome: 'He slides in the winner for a teammate — no glory, all class. The room loves him for it.', effect: { form: 0.08, attr: { teamwork: 1, creativity: 1 }, meters: { agent: -8, peers: 14, fans: 8 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'smash', label: 'Lash it in', desc: 'No thinking — just hit it', outcome: 'The net bulges and the stadium detonates. He wheels away, shirt off, booked and beaming. Scenes.', effect: { earnings: -60, form: 0.12, market: 3, attr: { composure: 1, aggression: 1 }, meters: { authority: -5, fans: 20, peers: 10 } } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'curl', label: 'Curl it into the top bino', desc: 'Go for the ridiculous, the unforgettable', outcome: 'He bends it up and over the wall into the postage stamp — a hat-trick sealed in the most outrageous fashion. The ball is his, the night is his, and the stands are bedlam.', effect: { energy: -6, greed: 2, form: 0.13, market: 4, attr: { flair: 2, composure: 1 }, meters: { fans: 24, peers: 8 } } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'kept-the-vow', label: 'Score it for the town', desc: 'He promised a terrace full of nobodies, years ago', outcome: 'He made a promise once from a cold terrace with a pie going soft in his hand, and he has carried it like a stone ever since. He puts it away without celebrating at all, then turns and points at his own end until his arm shakes. Debt paid, in front of everyone.', effect: { energy: -10, form: 0.13, market: 4, attr: { leadership: 2, composure: 1 }, meters: { fans: 26, sponsors: -6 } }, requires: 'world-town-vow' },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'panenka', label: 'Dink the Panenka', desc: 'Ice-cold audacity or eternal ridicule', outcome: 'He chips it feather-soft down the middle as the keeper hurls himself away, the ball settling in the empty net like a snowflake. The nerve of it! His teammates bury him beneath a mountain of bodies — the coolest man in the country.', effect: { form: 0.13, market: 5, attr: { composure: 2, flair: 1 }, meters: { authority: -8, fans: 24, peers: 12 } } },
          ...
          { id: 'volunteered-again', label: 'Take it the way he always has', desc: 'He put his hand up for one of these as a boy', outcome: 'He was the only one who put a hand up in a shootout on a windswept field years ago, and he has taken every one since exactly the same way — one spot chosen early, no thinking, no changing his mind. It goes precisely where it always goes.', effect: { energy: -8, form: 0.13, market: 4, attr: { composure: 2, leadership: 1 }, meters: { fans: 22, peers: 10, authority: -5 } }, requires: 'away-pens-volunteered' },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'dummy', label: 'Wait, dummy the keeper, roll it in', desc: 'Slow it down, freeze the goalie, make him commit', outcome: 'He deliberately slows, lets the keeper come, sells him a shot that never arrives, and strolls the ball into the vacated net with an outrageous coolness. Seventy yards of sprint and then the calmest of finishes — a solo counter of pure, taunting composure.', effect: { form: 0.12, market: 4, attr: { composure: 2, flair: 1 }, meters: { peers: -6, fans: 20 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'block', label: 'Block it flat and safe', desc: 'Get a solid body behind it, no theatrics', outcome: 'He abandons the acrobatics, plants himself square in the flight, and lets the ball thud harmlessly into his chest before shepherding it away. No highlight reel, but a defender reading danger and killing it with cold, unfussy certainty. The bench exhales as one.', effect: { form: 0.09, attr: { composure: 2, teamwork: 1 }, meters: { agent: -4, peers: 12, fans: 8 } } },
        ],
      },
    },
  },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'strong', label: 'Get a strong palm behind it', desc: 'Trust the reach, punch it down and smother the rebound', outcome: 'He throws a firm palm at it and beats it straight down, then scrambles across to swallow the loose ball before anyone can pounce. Not the balletic tip, but a keeper trusting his positioning and hands to snuff out the danger twice over. Ruthlessly efficient.', effect: { form: 0.1, attr: { keeping: 2, composure: 1 }, meters: { agent: -5, fans: 16, peers: 8 } } },
        ],
      },
    },
  },
