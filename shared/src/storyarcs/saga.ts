...
export const SAGA_ARCS: StoryArc[] = [
  {
    ...
    beats: {
      ...
      stayed: {
        ...
        choices: [
          { id: 'accept', label: 'Embrace it', desc: 'Become the club’s talisman', outcome: 'He carries the team on his back — and grows into a leader for it.', effect: { attr: { leadership: 2, composure: 1 }, meters: { authority: 8 }, form: 0.05, energy: -10 } },
  ...
  },
  {
    ...
    beats: {
      ...
      test: {
        ...
        choices: [
          { id: 'rally', label: 'Rally them', desc: 'A speech from the heart — drag them back into it', outcome: 'His words land. They come out transformed and salvage a draw. A captain is born.', effect: { attr: { leadership: 2, composure: 1 }, meters: { authority: 10, peers: 8 }, form: 0.06, energy: -6 } },
  ...
  },
  {
    ...
    beats: {
      ...
      finalday: {
        ...
        choices: [
          { id: 'hero', label: 'Gamble everything', desc: 'Throw himself at it — hero or villain', outcome: 'He bundles it in at the death. Survival! Grown men weep in the stands, chanting his name.', effect: { form: 0.12, attr: { composure: 1, aggression: 1 }, meters: { fans: 24, authority: 10 }, energy: -12 } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'freedom', label: 'Sell them freedom', desc: 'Tell them there’s no pressure — go and enjoy the ride', outcome: 'He shrugs and grins: nothing to lose, everything to gain. The tension drains out of them.', effect: { attr: { composure: 1, flair: 1 }, meters: { peers: 10, authority: -5 }, form: 0.06, tag: 'loose' }, next: 'giant' },
        ],
      },
      giant: {
        id: 'giant',
    ...
    beats: {
      ...
      debut: {
        ...
        choices: [
          ...
          { id: 'prove', label: 'Prove he’s not finished', desc: 'Show the doubters the old magic never left', outcome: 'He runs the game from memory and instinct, silencing anyone who called him a nostalgia signing.', effect: { form: 0.08, attr: { creativity: 1, composure: 1 }, meters: { fans: 18 }, energy: -12 }, next: 'legacy' },
        ],
      },
      legacy: {
        id: 'legacy',
  ...
  },
  {
    ...
    beats: {
      ...
      battle: {
        ...
        choices: [
          { id: 'masterclass', label: 'Deliver a masterclass', desc: 'Put on a display of pure, unarguable quality', outcome: 'He runs the practice match like a maestro, leaving no doubt whose shirt it is. The staff exchange glances.', effect: { form: 0.1, attr: { creativity: 1, composure: 1 }, meters: { authority: 8, peers: -6 }, energy: -8 }, next: 'verdict' },
    ...
    beats: {
      ...
      settle: {
        ...
        choices: [
          ...
          { id: 'football', label: 'Let his feet speak', desc: 'Skip the small talk and simply be undeniable on the pitch', outcome: 'He answers every doubt with the ball at his feet; some things need no translation, and respect follows the goals.', effect: { form: 0.09, attr: { flair: 1, composure: 1 }, meters: { peers: 8, fans: 6 }, energy: -10 }, next: 'return' },
        ],
      },
      return: {
        id: 'return',
        ...
        choices: [
          ...
          { id: 'go-back', label: 'Return transformed', desc: 'Go home a wiser, harder, more complete footballer', outcome: 'He flies back a different player, the foreign schooling burned into him, ready to prove they were wrong to let him leave.', effect: { attr: { creativity: 1, teamwork: 1 }, meters: { authority: 6, peers: 6 }, form: 0.07, earnings: -200 } },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    beats: {
      ...
      reclaim: {
        ...
        choices: [
          { id: 'lead', label: 'Become undroppable', desc: 'String together performances no manager could bench', outcome: 'He turns a lifeline into a stranglehold on the shirt, so consistent the debate simply ends.', effect: { attr: { leadership: 1, composure: 1 }, meters: { authority: 10, fans: 12 }, form: 0.06, energy: -12 } },
  ...
  },
  {
    ...
    beats: {
      ...
      'home-leg': {
        ...
        choices: [
          { id: 'grab', label: 'Take it himself', desc: 'Snatch the ball and stare down the away end', outcome: 'He buries it and cups an ear to the visiting fans as flares rain down. A local legend is minted in one swing of his boot.', effect: { form: 0.12, attr: { aggression: 1, composure: 1 }, meters: { fans: 22, authority: -5 } }, next: 'reckoning' },
  ...
  },
  {
    ...
    beats: {
      ...
      'dark-days': {
        ...
        choices: [
          { id: 'obsess', label: 'Double the work', desc: 'Add solo sessions nobody asked for until the plateau cracks', outcome: 'He films his own drills at dawn and hunts flaws in his gait like a scientist. Slowly, agonisingly, the knee starts to answer.', effect: { attr: { stamina: 2, composure: 1 }, meters: { authority: 6, family: -8 }, form: 0.04, energy: -14 }, next: 'return-day' },
          { id: 'lean', label: 'Lean on his people', desc: 'Let family and the dressing room carry him when his own belief fails', outcome: 'He stops trying to be a hero about it and lets the people who love him hold the weight for a while. He heals in more ways than one.', effect: { attr: { teamwork: 1, composure: 1 }, meters: { family: 10, peers: 10, partner: 8, authority: -6 } }, next: 'return-day' },
        ],
      },
      'return-day': {
        id: 'return-day',
    ...
    beats: {
      ...
      'twilight-home': {
        ...
        choices: [
          ...
          { id: 'lastdance', label: 'Chase one last trophy', desc: 'Refuse the wind-down and go all-in on a final medal', outcome: 'He tells the young boss he isn’t here to fade away, and drags his aching body toward one more piece of silverware out of sheer will.', effect: { attr: { aggression: 1, composure: 1 }, meters: { fans: 14, authority: 6 }, form: 0.06, energy: -16 } },
        ],
      },
      'twilight-away': {
        id: 'twilight-away',
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'fearless', label: 'Play without fear', desc: 'Attack the giant like there’s nothing to lose', outcome: 'He leads a swashbuckling charge that stuns the favourites, and the cameras leave with a new cult hero to talk about all week.', effect: { attr: { flair: 1, aggression: 1 }, meters: { fans: 16, sponsors: 4 }, form: 0.06, energy: -10, tag: 'cup-cavalier' }, next: 'semi' },
          { id: 'gameplan', label: 'Strangle the game', desc: 'Suffocate the giant and nick it on the break', outcome: 'He marshals a masterclass of discipline, defends for his life, and springs the counter that ends the tie. Ugly, brilliant, unforgettable.', effect: { attr: { teamwork: 2, composure: 1 }, meters: { peers: 10, authority: 6 }, form: 0.05, energy: -6, market: -2, tag: 'cup-tactician' }, next: 'semi' },
        ],
      },
      semi: {
        id: 'semi',
    ...
    beats: {
      ...
      clash: {
        ...
        choices: [
          ...
          { id: 'win-over', label: 'Win him over', desc: 'Take the superstar out and turn a rival into an ally', outcome: 'He swallows the jibe and invests in the man instead, and by dessert the two are laughing. A dressing room united sooner than anyone expected.', effect: { attr: { teamwork: 2, composure: 1 }, meters: { peers: 10, sponsors: 4, fans: -6 } }, next: 'verdict' },
        ],
      },
      verdict: {
        id: 'verdict',
    ...
    beats: {
      ...
      crossover: {
        ...
        choices: [
          ...
          { id: 'take-it', label: 'Take the shirt', desc: 'Back himself for the big one — the kid can wait his turn', outcome: 'He tells the boss the number’s still his when it matters, and delivers a performance that reminds everyone why. The heir sits, and learns.', effect: { form: 0.08, attr: { composure: 1, flair: 1 }, meters: { authority: 6, fans: 10, peers: -8 }, energy: -6 }, next: 'succession' },
        ],
      },
      succession: {
        id: 'succession',
  ...
  },
  {
    ...
    beats: {
      ...
      promotion: {
        ...
        choices: [
          { id: 'redemption', label: 'Complete the redemption', desc: 'Back himself to fire the club and his career back to life', outcome: 'He whips it into the top corner and the ramshackle stand collapses in joy. Promotion won, reputation reborn, the fallen star risen again.', effect: { form: 0.13, attr: { composure: 1, flair: 1 }, meters: { fans: 22, authority: 10 }, market: 2, energy: -10 } },
  ...
  },
  {
    ...
    beats: {
      ...
      legacy: {
        ...
        choices: [
          { id: 'thrive', label: 'Thrive in the new world', desc: 'Fully become a player of the ambitious modern club', outcome: 'He sheds the last of his nostalgia and reinvents himself for the elite level the owners demand, chasing trophies the old club never dared dream of.', effect: { attr: { composure: 1, stamina: 1 }, meters: { authority: 6, sponsors: 6, fans: -10 }, form: 0.06, energy: -8 } },
    ...
    beats: {
      open: {
        ...
        choices: [
          ...
          { id: 'bold', label: 'Show he belongs', desc: 'Play with the swagger that earned the call in the first place', outcome: 'He refuses to shrink, taking on the senior men in training with the fearlessness that got him noticed. The staff exchange approving glances.', effect: { attr: { flair: 1, aggression: 1 }, meters: { fans: 6, authority: 4, peers: -8 }, form: 0.05, tag: 'cap-bold' }, next: 'debut' },
        ],
      },
      debut: {
        id: 'debut',
    ...
    beats: {
      ...
      reception: {
        ...
        choices: [
          ...
          { id: 'goad', label: 'Silence them with malice', desc: 'Score and wheel away to bask in their fury', outcome: 'He rifles it home and sprints to cup his ears at the home end, a villain now and forever, adored by his new tribe.', effect: { form: 0.1, attr: { aggression: 2, flair: 1 }, meters: { fans: 14, authority: -8 }, market: 2 } },
        ],
      },
      'stayed-hero': {
        id: 'stayed-hero',
  ...
  },
  {
    ...
    beats: {
      ...
      charge: {
        ...
        choices: [
          { id: 'own', label: 'Own the contradiction', desc: 'Take the gift, score, and admit the system cuts both ways', outcome: 'He buries the spot-kick and tells the cameras, straight-faced, that maybe the machines get one right now and then. The game laughs with him.', effect: { form: 0.1, attr: { composure: 1, flair: 1 }, meters: { fans: 12, authority: 4 }, earnings: -200 } },
  ...
  },
  {
    ...
    beats: {
      ...
      ovations: {
        ...
        choices: [
          { id: 'earn', label: 'Play, don’t parade', desc: 'Demand to be treated as a footballer, not a farewell', outcome: 'He tells the boss to bench him the moment he’s a passenger, and backs it up with performances that silence the doubt entirely.', effect: { form: 0.09, attr: { stamina: 1, composure: 1 }, meters: { authority: 8, peers: 8 }, energy: -10 } },
          { id: 'embrace', label: 'Let them have it', desc: 'Give the fans the goodbye they’ve paid to see', outcome: 'He leans into every ovation and gifts the crowds their memories, a lap of honour a year long that no one who saw it forgets.', effect: { attr: { flair: 1 }, meters: { fans: 18, sponsors: 10 }, market: 2, form: -0.06 } },
        ],
      },
      'last-run': {
        id: 'last-run',
        ...
        choices: [
          { id: 'walk', label: 'Walk away on top', desc: 'Retire at the summit, on his own terms, no regrets', outcome: 'He plays his last game as one of his best, then hangs the boots up in the dressing room and closes the door softly. Perfect timing.', effect: { attr: { composure: 1, leadership: 1 }, meters: { fans: 14, family: 8, peers: 10 }, earnings: -600 } },
  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'attack', label: 'Chase every goal', desc: 'Argue they must win big and bury the margin beyond doubt', outcome: 'He makes the case for the throat, not the safe hands — pile the goals on and take the title out of anyone else’s reckoning.', effect: { attr: { aggression: 1, flair: 1 }, meters: { authority: 6, fans: 8, peers: -6 }, tag: 'gd-attack' }, next: 'goal-glut' },
          { id: 'control', label: 'Protect the cushion', desc: 'Argue for control — a clean sheet keeps the margin intact', outcome: 'He preaches discipline: don’t throw open a race they lead, strangle the game and let the arithmetic do the rest.', effect: { attr: { composure: 2, teamwork: 1 }, meters: { authority: 6, peers: 8, fans: -8 }, tag: 'gd-control' }, next: 'clean-sheet' },
        ],
      },
      'goal-glut': {
        id: 'goal-glut',
