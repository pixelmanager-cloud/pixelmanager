  ...
  },
  {
    ...
    beats: {
      open: {
        ...
        choices: [
          { id: 'go', label: 'Go, obviously', desc: 'It never occurs to him not to', outcome: 'He goes. Six of the squad don\'t. The coach says nothing about it at the time and forgets none of it later.', effect: { energy: -8, form: 0.07, attr: { stamina: 1 }, meters: { authority: 6, peers: 2 }, tag: 'season-boxingday-went' }, next: 'after' },
