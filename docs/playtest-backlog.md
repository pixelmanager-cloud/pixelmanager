...
- [ ] **PT-2 (manager balance): top-flight titles are too rare (~5%/season).** A peak club that has climbed to
...
- [ ] **PT-1 (player content): ~24% of turns are a "bad hand"** — no card in the drawn hand gets even a fair
